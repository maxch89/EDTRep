...
Процедура ПолучитьЗначениеВложенныхСвойств(ИсточникСвойства, ВложенныеСвойства, ЗначениеСвойства)
	ИмяКонечногоСвойства = ВложенныеСвойства[ВложенныеСвойства.Количество()-1];
	Если ИсточникСвойства.Свойство(ИмяКонечногоСвойства, ЗначениеСвойства) Тогда
		Возврат;
	КонецЕсли;
	ТекущийИсточникСвойства = ИсточникСвойства;
	ТекущееЗначениеСвойства = Неопределено;
	Для Уровень = 0 По ВложенныеСвойства.Количество()-2 Цикл
		Если НЕ ТекущийИсточникСвойства.Свойство(ВложенныеСвойства[Уровень], ТекущееЗначениеСвойства) Тогда
			Прервать;
		КонецЕсли;
		Если Уровень = ВложенныеСвойства.Количество()-2 Тогда
