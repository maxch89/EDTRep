...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Отказ = Ложь;
	КонвертацияДанныхXDTOСервер.УстановитьМонопольныйРежимДляОтключенияДемоБазыОтГлавногоУзла(Отказ);
	Если Отказ Тогда
		Параметры.Вставить("НеУдалосьУстановитьМонопольныйРежимПриОтлюченииДемоБазыОтГлавногоУзла");
	Иначе
		КонвертацияДанныхXDTOСервер.ОтключитьДемонстрационнуюБазуОтГлавногоУзлаПриНеобходимости();
	КонецЕсли;
	КонвертацияДанныхXDTOСервер.ПараметрыРаботыКлиентаПриЗапуске(Параметры);
