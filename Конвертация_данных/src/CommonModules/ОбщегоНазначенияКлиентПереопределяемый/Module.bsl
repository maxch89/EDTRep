...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	Если Параметры.Свойство("НеУдалосьУстановитьМонопольныйРежимПриОтлюченииДемоБазыОтГлавногоУзла") Тогда
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
		Если ПараметрыРаботыКлиента.Свойство("ПоказатьПомощникБыстрогоОсвоения") И
			ПараметрыРаботыКлиента.ПоказатьПомощникБыстрогоОсвоения Тогда
			ОткрытьФорму("Обработка.ПомощникБыстрогоОсвоения.Форма");
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
